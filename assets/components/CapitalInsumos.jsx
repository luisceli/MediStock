...
const CapitalInsumos = () => {
  ...
  const fetchCostoTotal = async () => {
    try {
      const costoTotalResponse = await axios.get(
        `${baseUrl}insumos/get/costototal`
      );
  ...
  const handleGuardarReporte = async () => {
    try {
      ...
      const response = await axios.get(`${baseUrl}insumos/get/reportetotal`);
  ...
  useEffect(() => {
    ...
    const fetchDataId = async (id) => {
      try {
        const dataId = await axios.get(`${baseUrl}insumos/${id}`);
  ...
  const handleActualizarProyeccion = async () => {
    if (selectedItemData) {
      try {
        ...
        await axios.put(`${baseUrl}insumos/${selectItemid}`, selectedItemData);
    ...
    <View style={{ marginTop: Constants.statusBarHeight }}>
      ...
      <View style={styles.dataListContainer}>
        <View style={styles.rowContainer}>
          ...
          <Text style={styles.headerText}>Sinonimo</Text>
          <Text style={styles.headerText}>Nivel de{"\n"}Riesgo</Text>
          ...
          renderItem={({ item }) => (
            <TouchableOpacity onPress={() => handleRowPress(item)}>
              <View style={styles.rowContainer}>
                ...
                <Text style={styles.columnText}>{item.sinonimo}</Text>
                <Text style={styles.columnText}>{item.nivel_Riesgo}</Text>
              ...
              <View style={styles.modalContainer}>
                ...
                {selectedItemData ? (
                  <>
                    ...
                    <Text>
                    Sinonimo: {selectedItemData.sinonimo}
                    </Text>
                    <Text>Nivel de Riesto: {selectedItemData.nivel_Riesgo}</Text>
